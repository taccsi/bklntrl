...
$document->addScriptDeclaration('$j(document).ready(function() { $j("a.zoom").fancybox({"zoomSpeedIn":300,"zoomSpeedOut":300,"overlayShow":false,"hideOnOverlayClick":true});});');
...
require_once( JPATH_COMPONENT.DS.'helpers/recommend.php' );
