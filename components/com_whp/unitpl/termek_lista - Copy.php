...
class atvevohely_lista extends base_template{
	...
	function getTpl()
	{
        ...
        <div class="listaelem">
            ...
            <ul class="ul_arak">
            	<li class="kosar_sarga"><div class="bal"><span class="ar_nev"><?php echo JText::_("KONYV_MEGRENDELESE"); ?></span>{arHTML}</div><div class="jobb">{kosar}</div></li>
            	<li class="kosar_barna"><div class="bal"><span class="ar_nev"><?php echo JText::_("EOK"); ?></span>{arHTML}</div><div class="jobb">{kosar}</div></li>
                <li class="kosar_barna"><div class="bal"><span class="ar_nev"><?php echo JText::_("FAPADOSKONYV"); ?></span>{arHTML}</div><div class="jobb">{kosar}</div></li>
            </ul>   
        </div>
