...
class xmljogtul extends xmlParser{
	...
	function getKimutatas( $node ){
		...
		$ret = "";
		$ret .= $this -> getSearch();
		$this->document->addscriptdeclaration("window.addEvent(\"domready\", function(){getJogtulKimutatas();})");		
		...
		$ret .= "<div id=\"ajaxContentJogtulKimutatas\"></div>";		
		return $ret;
	}
	...
	function getSearchArr( $js = "getJogtulKimutatas()" ){
		$arr = array();
		$obj = "";		
		$name = "cond_ev";
		$arr_ = array();
