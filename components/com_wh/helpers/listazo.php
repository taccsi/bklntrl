...
class listazo extends SimpleImage{
 function __construct($arr=array(), $class = "", $lapozoFelso="", $lapozoAlso="", $kivetelArr=array(), $sw="", $cellspacing="" ){
      $this->sw = $sw;
      $this->arr = $arr;
   ...
   function sortable(){
      ...
      <?php 
      if($this->lapozoFelso){
         echo "<tr><td class=\"td_lapozo td_lapozo_felso\" colspan=\"{$this->oszlopSzam}\">{$this->lapozoFelso}</td></tr>";
      }
      ?>
        <tr>
      <?php
