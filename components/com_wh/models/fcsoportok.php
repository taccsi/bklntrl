...
class whModelFcsoportok extends modelBase
{
	...
	function __construct()
	{
		...
		$this->xmlParser = new xmlFcsoport("fcsoport.xml");	
	}//function

	function _buildQuery()
	{
		$cond = $this->getCond();	
		$query = "SELECT * FROM #__wh_fcsoport as fcsoport {$cond} order by fcsoport.nev";
		//echo $query;
		return $query;
	}
