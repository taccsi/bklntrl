...
<input type="hidden" id="bsznev" value="<?php echo str_replace('"','',$this->hirlevel_cim->nev); ?>" />
<div class="div_wh_top_holder">
  <h3 class="h3_hirlevel_cimheading"><?php echo JText::_("HIRLEVEL_CIM") ?></h3>
...
<input type="hidden" name="controller" value="hirlevel_cim" />
