...
<input type="hidden" id="bsznev" value="<?php echo str_replace('"','',$this->gyarto->nev); ?>" />
<div class="div_wh_top_holder">
  <h3 class="h3_contentheading"><?php echo JText::_("GYARTO ADATLAP") ?></h3>
</div>
...
<input type="hidden" name="controller" value="gyarto" />
</form></div>
