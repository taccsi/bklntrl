...
<input type="hidden" id="bsznev" value="<?php echo str_replace('"','',$this->hirlevel->nev); ?>" />
<div class="div_wh_top_holder">
  <h3 class="h3_hirlevelheading"><?php echo JText::_("TARTALMI_ELEM_ADATLAP") ?></h3>
...
<table class="table_csoportok" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td>
    <fieldset>
    <?php echo  html_entity_decode($this->allGroups["folyamat"]) ;  ?> 
    </fieldset>
    </td>
  </tr>
</table>
...
<input type="hidden" name="controller" value="hirlevel" />
